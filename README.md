...
Data Model
Fact Tables
VulnDevice - Vulnerabilities joined with software and recommendations
SoftwareDevice - Software inventory with vulnerability counts
Dimension Tables
Rec - Recommendations dimension
Linkage
